...
</span> Würden zwei Personen (des gleichen Geschlechts) in einem Bett schlafen und
am nächsten Morgen auf dem Bett dann Manī vorfinden, ohne zu wissen, von wem es stammt,
so müsste keiner der beiden den Ghusl vollziehen. Der Grund hierfür ist, dass es
bei beiden Personen unsicher wäre und Zweifel keine Janabah herbeiführen können.
